 ...
 * Course: COMP-003A
 * Purpose: Lecture activity for variable, type system, math,and console properties
 * Reference: The C# Players Guide (4e) by RB Whitaker
 */
...
namespace COMP002A.LectureText
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int score; // declare a new variable with a data type int
                       // score = "Generic User"; // will fail to compile because you are assigning
            ...
            score = 0; // works
            score = 4; // you can also reassign values to the variable as long as they
             ...
             * a specific type.)
             * the System.Convert class is a useful class to convert from one type to
             another.
             */
            ...
            */
            ...
            Console.WriteLine($"Value of avogadros number: {avogadrosNumber} ");
            ...
            */
            ...
            // result: What is your name, human? Demetrius
